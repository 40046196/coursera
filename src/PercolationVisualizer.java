...
public class PercolationVisualizer {
    ...
    public static void main(String[] args) {
        StdOut.println("READ THE ARGUMENT " );
        
        StdOut.println("READ THE ARGUMENT " + java.util.Arrays.toString(args));

    	In in = new In(args[0]);      // input file
        
        int n = in.readInt();         // n-by-n percolation system
        StdOut.println("READ THE ARGUMENT " + n);
        ...
        StdOut.println("ISFULL 4-4 " + perc.isFull(4, 4));
    }
}
