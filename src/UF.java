...
public class UF {
    ...
    public int findLargest(int p) {
        validate(p);
        int valueIndex = parent[p]; // this is the value of input, ex 4
        int realValue = -1;
    	for (int i=0; i < parent.length;i++) {
    		if (valueIndex != parent[i]) {
    			realValue = i;
    		}
    	}
    	return realValue;
...
//        
//        
//        StdOut.println("Sekarang  Find(2) = "  + uf.find(2));
//        StdOut.println("Sekarang  FindLargetst(2) = "  + uf.findLargest(2));
//        
//        StdOut.println("Sekarang  Find(0) = "  + uf.find(0));
//        StdOut.println("Sekarang  FindLargetst(0) = "  + uf.findLargest(0));
//        StdOut.println("Sekarang  Find(7) = "  + uf.find(7));
//        StdOut.println("Sekarang  FindLargetst(7) = "  + uf.findLargest(7));
//        
//        StdOut.println("Sekarang  Find(3) = "  + uf.find(3));
//        StdOut.println("Sekarang  FindLargetst(3) = "  + uf.findLargest(3));
//        StdOut.println("Sekarang  Find(4) = "  + uf.find(4));
//        StdOut.println("Sekarang  FindLargetst(4) = "  + uf.findLargest(4));
//        StdOut.println("Sekarang  Find(8) = "  + uf.find(8));
//        StdOut.println("Sekarang  Find(9) = "  + uf.find(9));
