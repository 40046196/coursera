 ...
 * @author ISchwarz
 */
public class PercolationStatsOW {
    ...
    public PercolationStatsOW(int N, int T) { // perform T independent experiments on an N-by-N grid
        if (N <= 0) {
    ...
    public static void main(String[] args) {
        ...
        PercolationStatsOW stats = new PercolationStatsOW(N, T);
